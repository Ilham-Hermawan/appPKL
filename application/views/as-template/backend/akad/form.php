...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <?php
      !empty($data['set']->akad_id) ? $id = $data['set']->akad_id : $id = "0";
    ...
    ?>
    <?= form_open("dashboard/admin/transaksi/akad/save", $atrform); ?>
    <?= form_hidden('id', $id); ?>
    <div class="box">
              ...
              <div class="form-group">
                <?php
                  $atrNo = array(
                    ...
                    'autocomplete'=> 'off',
                    'required'    => 'required',
                    'value'       => !empty($data['akad_no']) ? $data['akad_no'] : $data['set']->akad_no
                  );
                  if(!empty($data['set']->akad_no)){
                    $atrNo['readonly'] = 'true';
                  }
                ?>
                <div class="row">
              ...
              <div class="form-group">
                <?php
                  $atrTgl = array(
                    ...
                    'autocomplete'=> 'off',
                    'required'    => 'required',
                    'value'       => !empty($data['set']->akad_date) ? $data['set']->akad_date : date('Y-m-d')
                  );
                ?>
                <div class="row">
                  <div class="col-sm-12">
                  ...
                  <?php foreach($data['detil'] as $row): ?>
                    <tr>
                      <td>
                        ...
                        <input type="hidden" id="IDDWawancara" name="IDDWawancara[]" value="<?= $row->ad_id ?>">
                      </td>
                      <td>
                      ...
                      <td>
                        <a class="btn btn-danger" href="<?= site_url('transaksi/detil_wawancara_delete/'.$id.'/'.$row->ad_id); ?>" /><i class="fa fa-trash-o"></i></a>
                      </td>
                    </tr>
                  <?php endforeach; ?>
                <?php else: ?>
      ...
      <div class="box-footer">
        <div class="text-right">
          ...
          ?>
          <a href="<?php echo site_url('dashboard/admin/transaksi/akad/list'); ?>" title="Back" class="btn btn-default">Kembali</a>
          <?= form_submit($atrBtn); ?>
        </div>
      </div>
    </div><!-- /.box -->

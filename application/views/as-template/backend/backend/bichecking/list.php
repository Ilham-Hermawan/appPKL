...
<div class="content-wrapper">
  ...
  <section class="content-header content-header-default">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">BI Checking</li>
    </ol>
  </section>
  ...
  <section class="content">
    ...
    <div class="box">
      ...
      <div class="box-body">
        ...
        <table id="data-table" class="table table-bordered table-hover" width="100%" style="font-size:13px;">
          <thead>
            <tr>
              <th></th>
              <th></th>
    ...
    $(window).load(function(){
      ...
      function loadDt(perumahan, status, dt1, dt2){
        $('#data-table').DataTable({
          ...
          "serverSide": true,
          "bDestroy" : true,
          "ajax": "<?= site_url('transaksi/get_bi_checking_list/'.'"+perumahan+"/"+status+"/"+dt1+"/"+dt2+"'); ?>",
          "sServerMethod": "POST",
          "language": {
          ...
          "order": [[ 0, "DESC" ]],
          "columns": [
            { "data": "bic_id", "width": "5%", name: "booking_id", "searchable": false, "sortable": false, className: 'text-center'},
            ...
            { "data": "bic_status", "sortable": true, "searchable": true, name: "bic_status", "width": "7%" },
            { "data": "bic_datetime", "sortable": true, "searchable": true, name: "bic_datetime", "width": "11%" }
          ],
          "columnDefs": [
            {
              "render": function ( data, type, row ) {
                return '<div class="btn-group">'+
                       ...
                       '<li><a href="javascript:void(0)" data-id="'+row.bic_id+'" status-id="y" booking-id="'+row.booking_id+'" title="Diterima" id="btn-diterima"><span class="fa fa-check text-green"></span> Diterima</a></li>'+
                       '<li><a href="javascript:void(0)" data-id="'+row.bic_id+'" status-id="n" booking-id="'+row.booking_id+'" title="Ditolak" id="btn-ditolak"><span class="fa fa-ban text-red"></span> Ditolak</a></li>'+
                       '</ul></div>';
              },
            ...
            {
              "render": function ( data, type, row ) {
                return '<span>KTP : <i>'+row.pelanggan_ktp+'</i></span><br/><span>Nama : '+data+'</span>';
              },

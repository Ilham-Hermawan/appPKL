...
<div class="content-wrapper">
  ...
  <section class="content-header content-header-default">
    ...
    <ol class="breadcrumb">
      ...
      <li>Biaya Persiapan & Pengolahan Tanah</li>
  ...
  <section class="content">
    ...
    <?php
      !empty($data['set']->bppt_id) ? $id = $data['set']->bppt_id : $id = "0";
    ...
    ?>
    <?= form_open_multipart("dashboard/owner/bppt/save", $atrform); ?>
    <?= form_hidden('id', $id); ?>
    <div class="box">
      ...
      <div class="box-body">
        ...
        <table style="width:100%" id="table">
          ...
          <tbody>
            ...
            <?php
              $uraian = array(
                'Biaya Pembebasan Lahan', 'Biaya Cut and Fill', 'Biaya Pengukuran & Pematokan', 'Biaya Pengurugan Badan Jalan',
                'Biaya Pengurugan Kavling Rumah/Fasum', 'Biaya Pembangunan Gudang', 'Biaya Lain-lain'
              );
            ?>
            <?php if(!empty($data['detil'])): ?>
              <?php foreach($data['detil'] as $row): ?>
                <tr>
                  ...
                  <td class="text-center"><a href="<?= site_url('rab/delete_bppt_detil/'.$row->drbp_id.'/'.$id); ?>" id="btn-delete-detil" style="margin-bottom:16px;" type="button" class="btn btn-sm btn-danger" onclick="deleteRow(this)"><i class="fa fa-trash-o"></i></button></td>
                </tr>
                <?php $i++; ?>
              <?php endforeach; ?>
            <?php else: ?>
          ...
          <tfoot>
            <tr>
              ...
              <td><div class="form-group"><input type="text" value="<?= !empty($data['set']->bppt_total) ? $data['set']->bppt_total : set_value('total_jumlah'); ?>" class="form-control inputHarga" id="total_jumlah" name="total_jumlah" placeholder="Rp. 0" autocomplete="off" readonly="true"></div></td>
            </tr>
          </tfoot>
        </table>
      ...
      <div class="box-footer">
        <div class="text-right">
          ...
          ?>
          <a href="<?php echo site_url('dashboard/owner/bppt/list'); ?>" title="Back" class="btn btn-default">Kembali</a>
          <?= form_submit($atrBtn); ?>
        </div>
      </div>
    </div><!-- /.box -->

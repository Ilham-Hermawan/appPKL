...
<div class="content-wrapper">
  ...
  <section class="content-header content-header-default">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Biaya Persiapan & Pengolahan Tanah</li>
    </ol>
  </section>
    ...
    <div class="box">
      ...
      <div class="box-body">
        <div style="margin-bottom:20px;">
          <div class="row">
            <div class="col-md-6">
              <a href="<?= site_url('dashboard/owner/bppt/add'); ?>" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah Data</a>
            </div>
    ...
    $(window).load(function(){
      ...
      $(document).on("click","a[id='btn-delete']", function (e) {
        ...
        function(isConfirm){
          if (isConfirm) {
            ...
            window.location.href = '<?= site_url('dashboard/owner/bppt/delete/'."'+id+'"); ?>';
          } else {
      ...
      function loadDt(){
        $('#data-table').DataTable({
          ...
          "serverSide": true,
          "bDestroy" : true,
          "ajax": "<?= site_url('rab/get_bppt_data/'); ?>",
          "sServerMethod": "POST",
          "language": {
          ...
          "order": [[ 0, "DESC" ]],
          "columns": [
            { "data": "bppt_id", "width": "2%", name: "bppt_id", "searchable": false, "sortable": false, className: 'text-center'},
            { "data": "rab_nama", "sortable": true, "searchable": true, name: "rab_nama" },
            { "data": "bppt_total", "sortable": true, "searchable": true, name: "bppt_total", "width": "18%" },
            { "data": "bppt_created", "sortable": true, "searchable": true, name: "bppt_created","width": "18%" },
            { "data": "bppt_modified", "sortable": true, "searchable": true, name: "bppt_modified","width": "18%" }
          ],
          "columnDefs": [
            {
              "render": function ( data, type, row ) {
                return '<div class="btn-group">'+
                       ...
                       '<li><a href="<?= site_url('dashboard/owner/bppt/edit/'."'+row.bppt_id+'") ?>" title="Edit"><span class="fa fa-pencil"></span> Edit</a></li>'+
                       '<li class="divider"></li>' +
                       '<li><a href="javascript:void(0)" data-id="'+row.bppt_id+'" title="Delete" id="btn-delete"><span class="fa fa-trash-o text-red"></span> Delete</a></li>'+
                       '</ul></div>';

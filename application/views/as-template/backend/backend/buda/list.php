...
<div class="content-wrapper">
  ...
  <section class="content-header content-header-default">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Biaya Umum dan Administrasi</li>
    </ol>
  </section>
    ...
    <div class="box">
      ...
      <div class="box-body">
        <div style="margin-bottom:20px;">
          <div class="row">
            <div class="col-md-6">
              <a href="<?= site_url('dashboard/finance/penerimaan/buda/add'); ?>" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah Data</a>
            </div>
    ...
    $(window).load(function(){
      ...
      $(document).on("click","a[id='btn-delete']", function (e) {
        ...
        function(isConfirm){
          if (isConfirm) {
            ...
            window.location.href = '<?= site_url('dashboard/finance/penerimaan/buda/delete/'."'+id+'"); ?>';
          } else {
      ...
      function loadDt(){
        $('#data-table').DataTable({
          ...
          "serverSide": true,
          "bDestroy" : true,
          "ajax": "<?= site_url('penerimaan/get_buda_data/'); ?>",
          "sServerMethod": "POST",
          "language": {
          ...
          "order": [[ 0, "DESC" ]],
          "columns": [
            { "data": "penerimaan_id", "width": "2%", name: "penerimaan_id", "searchable": false, "sortable": false, className: 'text-center'},
            { "data": "penerimaan_no", "sortable": true, "searchable": true, name: "penerimaan_no" },
            { "data": "rumah_nama", "sortable": true, "searchable": true, name: "rumah_nama" },
            { "data": "penerimaan_dari", "sortable": true, "searchable": true, name: "penerimaan_dari" },
            { "data": "penerimaan_total", "sortable": true, "searchable": true, name: "penerimaan_total", "width": "18%" },
            { "data": "penerimaan_created", "sortable": true, "searchable": true, name: "penerimaan_created","width": "18%" },
            { "data": "penerimaan_modified", "sortable": true, "searchable": true, name: "penerimaan_modified","width": "18%" }
          ],
          "columnDefs": [
            {
              "render": function ( data, type, row ) {
                return '<div class="btn-group">'+
                       ...
                       '<li><a href="<?= site_url('dashboard/finance/penerimaan/buda/print/'."'+row.penerimaan_id+'") ?>" target="_blank" title="Print"><span class="fa fa-print"></span> Kwitansi</a></li>'+
                       '<li><a href="<?= site_url('dashboard/finance/penerimaan/buda/edit/'."'+row.penerimaan_id+'") ?>" title="Edit"><span class="fa fa-pencil"></span> Edit</a></li>'+
                       '<li class="divider"></li>' +

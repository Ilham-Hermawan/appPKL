...
<body>
  ...
  <div class="content">
    ...
    <table width="100%" class="table">
      ...
      <tr>
        <td width="5%">No. </td>
        <td width="1%">:</td>
        <td width="40%"><strong><?= $set->akad_no ?></strong></td>
      ...
      <tr>
        ...
        <td width="1%">:</td>
        <td width="40%"><strong>Permohonan Akad Kredit</strong></td>
      </tr>
    </table>

    <br/><br/>
    <p>Dengan hormat,</p>
    <p>Sehubung dengan selesainya pembangunan Perumahan <?= $set->rumah_nama ?> Tahap IV <?= $set->kavling_blok ?> dan Terbitnya SP3K, maka dengan ini kami Mengajukan Akad Kredit yang akan di laksanakan pada tanggal ............<?= substr($tanggal,2); ?>.</p>
    <p>Adapun Nama-nama Konsumen Perumahan <?= $set->rumah_nama ?> sebagai berikut;</p>
    <p><i>- Terlampir</i></p>
    <p>Adapun Akad Kredit ini akan dilaksanakan di Notaris <strong>ISKANDAR, SH (Hp. 08125600102)</strong> dan pencairan mohon di debet <strong>rekeningGiro ; 00160.01.30.000060.5</strong> Atas Nama <strong>PT. RAVINDO KARYA</strong>, pada Bank BTN Pontianak.</p>
  ...
  <div style="page-break-after:auto">
    <br/><br/>
    <strong><u>Daftar Nama-nama Konsumen yang Akan di Akad Kredit :</u></strong>
    <br/><br/>

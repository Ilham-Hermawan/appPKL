...
<head>
	<meta charset="utf-8">
	<title>Surat Pencairan IMB</title>
	<style type="text/css">
  ...
  <div class="page-break-after:always">
    ...
    <table width="100%" class="table">
      ...
      <tr>
        <td width="5%">No. </td>
        <td width="1%">:</td>
        <td width="50%"><strong><?= $set->imb_no ?></strong></td>
    ...
    <br/><br/>
    <p>Dengan hormat,</p>
    <p>Bersama ini kami mohon bantuan Pencairan Dana Jaminan IMB untuk <?= $set->total ?> unit yang sudah diakad pada tanggal <?= $tanggal ?> Perumahan <?= $set->rumah_nama ?> <?= $set->rumah_alamat ?>, Kelurahan <?= $set->rumah_desa ?> Kecamatan <?= $set->rumah_kecamatan ?>, <?= $set->rumah_kota; ?>.</p>
    <p>Sebagai bahan pertimbangan kami lampirkan nama-nama Debitur, IMB (ASLI), dan SLO (ASLI).</p>

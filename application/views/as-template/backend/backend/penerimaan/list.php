                ...
                <div class="modal-body edit-content">
                  <table width="100%" class="table">
                    <tr>
                      ...
                      <th width="4%">:</th>
                      <td style="text-align:left;"><span id="no-booking"></span></td>
                    </tr>
                    <tr>
                      <th width="30%">Nama Pelanggan</th>
                      <th width="4%">:</th>
                      <td style="text-align:left;"><span id="nama-pelanggan"></span></td>
                    </tr>
                  </table>
                  <hr/>
                  <div class="row text-center">
                    <div class="col-md-6">
                      <p>Harga</p>
                      <h2 class="text-green" id="harga">0</h2>
                    </div>
                    <div class="col-md-6">
                      <p>Total Penerimaan</p>
                      <h2 class="text-green" id="total">0</h2>
                    </div>
                  </div>
                </div>
      ...
      $(document).on("click","a[id='btn-total']", function (e) {
        ...
        $.ajax({
             ...
             success: function (data) {
                 ...
                 //console.log(data);
                 $('#no-booking').text(obj.no_booking);
                 $('#nama-pelanggan').text(obj.nama_pelanggan);

    ...
    <div class="box">
      ...
      <div class="box-body">
        <div style="margin-bottom:20px;">
          <div class="row">
            <div class="col-md-6">
              <a href="<?= site_url('dashboard/admin/transaksi/wawancara/add'); ?>" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah Data</a>
            </div>
        ...
        <table id="data-table" class="table table-bordered table-hover" style="font-size:13px !important;" width="100%">
          <thead>
            ...
            <tr>
              ...
              <th class="dthead dthead-blue">NO WAWANCARA</th>
              <th class="dthead dthead-blue">PERIHAL</th>
    ...
    $(window).load(function(){
      ...
      $(document).on("click","a[id='btn-hapus']", function (e) {
        ...
        function(isConfirm){
          if (isConfirm) {
            ...
            window.location.href = '<?= site_url('transaksi/wawancara_delete/'."'+id+'"); ?>';
          } else {
      ...
      function loadDt(){
        $('#data-table').DataTable({
          ...
          "serverSide": true,
          "bDestroy" : true,
          "ajax": "<?= site_url('transaksi/get_wawancara_list/'); ?>",
          "sServerMethod": "POST",
          "language": {
          ...
          "order": [[ 0, "DESC" ]],
          "columns": [
            { "data": "wawancara_id", "width": "8%", name: "wawancara_id", "searchable": false, "sortable": false, className: 'text-center'},
            { "data": "wawancara_no", "sortable": true, "searchable": true, name: "wawancara_no", "width": "15%" },
            { "data": "wawancara_perihal", "sortable": true, "searchable": true, name: "wawancara_perihal" },
            { "data": "wawancara_tanggal", "sortable": true, "searchable": true, name: "wawancara_tanggal", "width": "8%" },
            { "data": "rumah_nama", "sortable": true, "searchable": true, name: "rumah_nama","width": "20%" },
          ],
          "columnDefs": [
            {
              "render": function ( data, type, row ) {
                return '<div class="btn-group">'+
                       ...
                       '<li><a href="<?= site_url('dashboard/admin/transaksi/wawancara/dokument/'."'+row.wawancara_id+'"); ?>" target="_blank" title="Print" id="btn-print"><span class="fa fa-print"></span> Print</a></li>'+
                       '<li><a href="<?= site_url('dashboard/admin/transaksi/wawancara/edit/'."'+row.wawancara_id+'"); ?>" title="Edit" id="btn-edit"><span class="fa fa-pencil"></span> Edit</a></li>'+
                       '<li><a href="javascript:void(0)" data-id="'+row.wawancara_id+'" title="Hapus" id="btn-hapus"><span class="fa fa-trash-o text-red"></span> Hapus</a></li>'+
                       '</ul></div>';

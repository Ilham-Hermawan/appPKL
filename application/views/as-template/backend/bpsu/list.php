...
<div class="content-wrapper">
  ...
  <section class="content-header content-header-default">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active"><<?= $data['sub_header_title'] ?></li>
    </ol>
  </section>
    ...
    <div class="box">
      ...
      <div class="box-body">
        <div style="margin-bottom:20px;">
          <div class="row">
            <div class="col-md-6">
              <a href="<?= site_url('dashboard/owner/bpsu/add'); ?>" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah Data</a>
            </div>
        ...
        <table id="data-table" class="table table-bordered table-hover" width="100%">
          <thead>
            ...
            <tr>
              ...
              <th class="dthead dthead-blue">Total Prasarana</th>
              <th class="dthead dthead-blue">Total Sarana</th>
    ...
    $(window).load(function(){
      ...
      $(document).on("click","a[id='btn-delete']", function (e) {
        ...
        function(isConfirm){
          if (isConfirm) {
            ...
            window.location.href = '<?= site_url('dashboard/owner/bpsu/delete/'."'+id+'"); ?>';
          } else {
      ...
      function loadDt(){
        $('#data-table').DataTable({
          ...
          "serverSide": true,
          "bDestroy" : true,
          "ajax": "<?= site_url('rab/get_bpsu_data/'); ?>",
          "sServerMethod": "POST",
          "language": {
          ...
          "order": [[ 0, "DESC" ]],
          "columns": [
            { "data": "bpsu_id", "width": "2%", name: "bpsu_id", "searchable": false, "sortable": false, className: 'text-center'},
            { "data": "rab_nama", "sortable": true, "searchable": true, name: "rab_nama" },
            { "data": "bpsu_totalp", "sortable": true, "searchable": true, name: "bpsu_totalp", "width": "18%" },
            { "data": "bpsu_totals", "sortable": true, "searchable": true, name: "bpsu_totals", "width": "18%" },
            { "data": "bpsu_created", "sortable": true, "searchable": true, name: "bpsu_created","width": "18%" },
            { "data": "bpsu_modified", "sortable": true, "searchable": true, name: "bpsu_modified","width": "18%" }
          ],
          "columnDefs": [
            {
              "render": function ( data, type, row ) {
                return '<div class="btn-group">'+
                       ...
                       '<li><a href="<?= site_url('dashboard/owner/bpsu/edit/'."'+row.bpsu_id+'") ?>" title="Edit"><span class="fa fa-pencil"></span> Edit</a></li>'+
                       '<li class="divider"></li>' +
                       '<li><a href="javascript:void(0)" data-id="'+row.bpsu_id+'" title="Delete" id="btn-delete"><span class="fa fa-trash-o text-red"></span> Delete</a></li>'+
                       '</ul></div>';

...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <?php
      !empty($data['set']->imb_id) ? $id = $data['set']->imb_id : $id = "0";
    ...
    ?>
    <?= form_open("dashboard/finance/transaksi/imb/save", $atrform); ?>
    <?= form_hidden('id', $id); ?>
    <div class="box">
              ...
              <div class="form-group">
                <?php
                  $atrNo = array(
                    ...
                    'autocomplete'=> 'off',
                    'required'    => 'required',
                    'value'       => !empty($data['imb_no']) ? $data['imb_no'] : $data['set']->imb_no
                  );
                  if(!empty($data['set']->imb_no)){
                    $atrNo['readonly'] = 'true';
                  }
                ?>
                <div class="row">
                  ...
                  <div class="col-sm-12">
                    <?php
                      $atrHarga = array(
                        ...
                        'autocomplete'=> 'off',
                        'required'    => 'required',
                        'value'       => !empty($data['set']->imb_harga) ? $data['set']->imb_harga : set_value('inputHarga')
                      );
                    ?>
                    <div class="row">
                      <div class="col-sm-12">
                  ...
                  <?php foreach($data['detil'] as $row): ?>
                    <tr>
                      <td>
                        ...
                        <input type="hidden" id="IDDWawancara" name="IDDWawancara[]" value="<?= $row->dimb_id ?>">
                      </td>
                      <td>
                      ...
                      <td>
                        <a class="btn btn-danger" href="<?= site_url('finance/detil_imb_delete/'.$id.'/'.$row->dimb_id); ?>" /><i class="fa fa-trash-o"></i></a>
                      </td>
                    </tr>
                  <?php endforeach; ?>
                <?php else: ?>
      ...
      <div class="box-footer">
        <div class="text-right">
          ...
          ?>
          <a href="<?php echo site_url('dashboard/finance/transaksi/imb/list'); ?>" title="Back" class="btn btn-default">Kembali</a>
          <?= form_submit($atrBtn); ?>
        </div>
      </div>
    </div><!-- /.box -->

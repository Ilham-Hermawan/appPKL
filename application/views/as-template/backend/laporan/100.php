...
<head>
	<meta charset="utf-8">
	<title>Surat Pencairan 100 Hari</title>
	<style type="text/css">
  ...
  <div class="page-break-after:always">
    ...
    <table width="100%" class="table">
      ...
      <tr>
        <td width="5%">No. </td>
        <td width="1%">:</td>
        <td width="50%"><strong><?= $set->j100_no ?></strong></td>
      ...
      <tr>
        ...
        <td width="1%">:</td>
        <td width="40%"><strong>Permohonan Pencairan Sertifikat</strong></td>
      </tr>
    </table>

    <br/><br/>
    <p>Dengan hormat,</p>
    <p>Bersama ini kami mohon bantuan Pencairan Sertifikat untuk <?= $set->total ?> unit yang sudah diakad pada tanggal <?= $tanggal ?> Perumahan <?= $set->rumah_nama ?> <?= $set->rumah_alamat ?>, Kelurahan <?= $set->rumah_desa ?> Kecamatan <?= $set->rumah_kecamatan ?>, <?= $set->rumah_kota; ?>.</p>
    <p>Sebagai bahan pertimbangan kami lampirkan nama-nama Debitur</p>

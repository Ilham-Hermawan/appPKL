  ...
  <div class="page-break-after:auto">
    ...
    <table width="100%" class="table">
      ...
      <tr>
        <td width="5%">No. </td>
        <td width="1%">:</td>
        <td width="40%"><strong><?= $set->wawancara_no ?></strong></td>
    ...
    <br/><br/>
    <p>Dengan hormat,</p>
    <p>Sehubung dengan hasil BI CHECKING dari Konsumen Perumahan <?= $set->rumah_nama ?>, maka dengan ini kami Mengajukan Wawancara Konsumen yang akan di laksanakan pada hari ............ tanggal ............ <?= substr($tanggal,2); ?>.</p>
    ...
    <br/><br/>
    <p>Demikian surat permohonan ini kami sampaikan untuk dapat ditindak lanjuti.</p>
    <p>Atas perhatian dan kerjasamanya dari pimpinan PT. Bank Tabungan Negara (Persero) Cabang Pontianak kami ucapakan terimakasih.</p>

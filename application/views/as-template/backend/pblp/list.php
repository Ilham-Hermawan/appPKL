...
<div class="content-wrapper">
  ...
  <section class="content-header content-header-default">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Legalitas & Perizinan</li>
    </ol>
  </section>
    ...
    <div class="box">
      ...
      <div class="box-body">
        <div style="margin-bottom:20px;">
          <div class="row">
            <div class="col-md-6">
              <a href="<?= site_url('dashboard/finance/pengeluaran/blp/add'); ?>" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah Data</a>
            </div>
    ...
    $(window).load(function(){
      ...
      $(document).on("click","a[id='btn-delete']", function (e) {
        ...
        function(isConfirm){
          if (isConfirm) {
            ...
            window.location.href = '<?= site_url('dashboard/finance/pengeluaran/blp/delete/'."'+id+'"); ?>';
          } else {
      ...
      function loadDt(){
        $('#data-table').DataTable({
          ...
          "serverSide": true,
          "bDestroy" : true,
          "ajax": "<?= site_url('pengeluaran/get_pblp_data/'); ?>",
          "sServerMethod": "POST",
          "language": {
          ...
          "columnDefs": [
            {
              "render": function ( data, type, row ) {
                return '<div class="btn-group">'+
                       ...
                       '<li><a href="<?= site_url('dashboard/finance/pengeluaran/blp/print/'."'+row.pengeluaran_id+'") ?>" target="_blank" title="Print"><span class="fa fa-print"></span> Kwitansi</a></li>'+
                       '<li><a href="<?= site_url('dashboard/finance/pengeluaran/blp/edit/'."'+row.pengeluaran_id+'") ?>" title="Edit"><span class="fa fa-pencil"></span> Edit</a></li>'+
                       '<li class="divider"></li>' +

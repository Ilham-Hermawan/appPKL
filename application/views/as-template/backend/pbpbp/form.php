...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    ?>
    <?= form_open_multipart("dashboard/finance/pengeluaran/bpbp/save", $atrform); ?>
    <?= form_hidden('id', $id); ?>
    <div class="box">
            ...
            <?php if(!empty($data['detil'])): ?>
              <?php foreach($data['detil'] as $row): ?>
                <tr>
                  ...
                  <td><div class="form-group"><input type="text" value="<?= ($row->dp_volume == 0) ? "" : $row->dp_volume; ?>" class="form-control volume" name="volume[]" placeholder="Volume" autocomplete="off"></div></td>
                  <td><div class="form-group"><input type="text" value="<?= $row->dp_satuan ?>" class="form-control satuan" maxlength="50" name="satuan[]" placeholder="Satuan" autocomplete="off"></div></td>
                  ...
                  <td class="text-center"><a href="<?= site_url('pengeluaran/delete_bpbp_detil/'.$row->dp_id.'/'.$id); ?>" id="btn-delete-detil" style="margin-bottom:16px;" type="button" class="btn btn-sm btn-danger" onclick="deleteRow(this)"><i class="fa fa-trash-o"></i></button></td>
                </tr>
                <?php $i++; ?>
              <?php endforeach; ?>
            <?php else: ?>
              <?php $i=1; ?>
                <tr>
                  ...
                  <td><div class="form-group"><input type="text" class="form-control satuan" maxlength="50" name="satuan[]" placeholder="Satuan" autocomplete="off"></div></td>
      ...
      <div class="box-footer">
        <div class="text-right">
          ...
          ?>
          <a href="<?php echo site_url('dashboard/finance/pengeluaran/bpbp/list'); ?>" title="Back" class="btn btn-default">Kembali</a>
          <?= form_submit($atrBtn); ?>
        </div>
      </div>
    </div><!-- /.box -->

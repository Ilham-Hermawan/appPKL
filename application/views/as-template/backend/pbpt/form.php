...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    ?>
    <?= form_open_multipart("dashboard/finance/pengeluaran/bpt/save", $atrform); ?>
    <?= form_hidden('id', $id); ?>
    <div class="box">
            ...
            <?php if(!empty($data['detil'])): ?>
              <?php foreach($data['detil'] as $row): ?>
                <tr>
                  ...
                  <td class="text-center"><a href="<?= site_url('pengeluaran/delete_bpt_detil/'.$row->dp_id.'/'.$id); ?>" id="btn-delete-detil" style="margin-bottom:16px;" type="button" class="btn btn-sm btn-danger" onclick="deleteRow(this)"><i class="fa fa-trash-o"></i></button></td>
                </tr>
                <?php $i++; ?>
              <?php endforeach; ?>
            <?php else: ?>
      ...
      <div class="box-footer">
        <div class="text-right">
          ...
          ?>
          <a href="<?php echo site_url('dashboard/finance/pengeluaran/bpt/list'); ?>" title="Back" class="btn btn-default">Kembali</a>
          <?= form_submit($atrBtn); ?>
        </div>
      </div>
    </div><!-- /.box -->

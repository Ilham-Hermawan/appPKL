...
<div class="content-wrapper">
  ...
  <section class="content-header content-header-default">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="<?= site_url('dashboard/rumah/list'); ?>">Project</a></li>
                ...
                <?php if(!empty($data['detil'])): ?>
                  <?php foreach($data['detil'] as $row): ?>
                    <tr>
                      ...
                      <td>
                        <input type="text" value="<?= $row->kavling_tipe ?>" class="form-control" name="tipe[]" maxlength="255" autocomplete="off" placeholder="Tipe">
                      </td>
                      <td>
                        <?php
                      ...
                      <td>
                        <?php
                          $pbb = !empty($row->kavling_pbb) ? $row->kavling_pbb : set_value('inputPbb[]');
                          $inputPbb = array(
                            'y' => "ADA",
                            'n' => "TIDAK ADA",
                            'p' => "PROSES"
                        ...
                        ?>
                        <?= form_dropdown('inputPbb[]', $inputPbb, $pbb, 'class="form-control"'); ?>
                      </td>
                      <td>
  ...
  $(window).load(function(){
    ...
    function addRow(){
      ...
      $('#kavling').append(''+
                            ...
                            '</td>'+
                            '<td>'+
                            '<input id="' + x + '" type="text" class="form-control" name="tipe[]" maxlength="255" autocomplete="off" placeholder="Tipe">'+
                            '</td>'+
                            '</td>'+
                            '<td>'+
                            ...
                            '</td>'+
                            '<td>'+
                            '<select name="inputPbb[]" class="form-control">'+
                            '<option value="y">ADA</option>'+
                            '<option value="n">TIDAK ADA</option>'+
                            '<option value="p">PROSES</option>'+
                            '</select>'+
